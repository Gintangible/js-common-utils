...
describe('removeEmptyFields', () => {
  ...
  it('参数为字符串类型数组，不包含空字符串', () => {
    const obj = ['a', 'b', 'c'];
    const result = removeEmptyFields(obj);
    expect(result).not.equal(obj);
    expect(result).eql(obj);
  });
  it('参数为字符串类型数组，包含空字符串', () => {
    const obj = ['a', 'b', ''];
    const result = removeEmptyFields(obj);
    expect(result).not.equal(obj);
    expect(result).not.eql(obj);
